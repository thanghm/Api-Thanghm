...
describe "Matches" do
  ...
  describe "GET /matches" do
    ...
    it "empty api_key" do
      ...
      get "/api/v1/matches/seach_matches", nil, { 'Apikey' => '', 'UserToken' => user.authentication_token }
      expect(response.to_a[0]).to eq 403
    end

    it "not authenticated" do
      get "/api/v1/matches/seach_matches", nil, { 'Apikey' => api_key.access_token, 'UserToken' => '' }
